...
function JourneySummary({
  ...
  return (
    <div
      className="relative min-h-[330px] rounded-3xl border border-slate-200 bg-white px-7 py-7 shadow-sm"
      id="results-journey"
    >
      <button
      ...
      <h3 className="text-3xl font-extrabold tracking-normal text-slate-950">
        Resumen
      </h3>

      <p className="mt-5 text-base leading-7 text-[#010B2F]">
      ...
      <p className="mt-6 max-w-3xl text-base leading-7 text-[#010B2F]">
        {summaryCopy}
      </p>

      <p className="mt-6 text-base leading-7 text-[#010B2F]">
        Si quieres aprender m&aacute;s sobre finanzas te invitamos a seguir:
      </p>

      <div className="mt-3 flex flex-wrap gap-6 text-sm font-extrabold text-blue-600">
